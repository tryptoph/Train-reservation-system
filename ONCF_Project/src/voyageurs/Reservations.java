...
public class Reservations {
    ...
    protected int nombreAdultes;
    protected int nombreEnfants;
    protected String confortSelectionne;
    private List<String> listeTrajets;
    private TrajetDAO.Trajet trajet;
    private ReductionDAO.Trajet trajetReduction;
	...
	public void setTrajet(TrajetDAO.Trajet trajet) {
        this.trajet = trajet;
    }

    public void setTrajetReduction(ReductionDAO.Trajet trajetReduction) {
        this.trajetReduction = trajetReduction;
    }

    public TrajetDAO.Trajet getTrajet() {
        return trajet;
    }

    public ReductionDAO.Trajet getTrajetReduction() {
        return trajetReduction;
    }
